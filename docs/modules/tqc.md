...
using 3 seeds.
The complete learning curves are available in the [associated PR](https://github.com/Stable-Baselines-Team/stable-baselines3-contrib/pull/4).

The main difference with SAC is on harder environments (BipedalWalkerHardcore, Walker2D).

:::{note}
Hyperparameters from the [gSDE paper](https://arxiv.org/abs/2005.05719) were used (as they are tuned for SAC on PyBullet envs),
...
You can find a complete benchmark on PyBullet envs in the [gSDE paper](https://arxiv.org/abs/2005.05719)
