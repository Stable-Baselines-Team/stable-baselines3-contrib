...
Performance evaluation of CrossQ on six MuJoCo environments, see [PR #243](https://github.com/Stable-Baselines-Team/stable-baselines3-contrib/pull/243).
Compared to results from the original paper as well as a version from [SBX](https://github.com/araffin/sbx).
