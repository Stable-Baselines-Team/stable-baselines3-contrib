...
class HybridActorCriticPolicy(BasePolicy):
    ...
    def forward(self, obs: th.Tensor, deterministic: bool = False) -> tuple[th.Tensor, th.Tensor, th.Tensor]:
        ...
        log_prob_d, log_prob_c = distribution.log_prob(actions_d, actions_c)
    ...
    def evaluate_actions(
        ...
        :param obs: Observation
        :param actions_d: Discrete actions
        :param actions_c: Continuous actions
        ...
        log_prob: tuple[th.Tensor, th.Tensor] = distribution.log_prob(actions_d, actions_c)
