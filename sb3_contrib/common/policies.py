...
class ESPolicy(BasePolicy):
    """
    Policy network for population based algorithms (evolution strategies).
    ...
    def __init__(
        ...
        if isinstance(action_space, spaces.Box):
            ...
            raise NotImplementedError(f"Error: ES policy not implemented for action space of type {type(action_space)}.")
...
class ESLinearPolicy(ESPolicy):
    """
    Linear policy network for evolution strategies (ES).
